---
title: Installation
description: Getting started with snapiui
icon: ListStart
---
...
```bash tab="bun"
bunx shadcn@latest add https://snapiui/r/utils.json
```
 
```bash tab="npx"
npx shadcn@latest add https://snapiui/r/utils.json
```

```bash tab="pnpm"
pnpm dlx shadcn@latest add https://snapiui/r/utils.json
```
...
```bash tab="bun"
bunx shadcn@latest add https://snapiui.vercel.app/r/card-05.json
```
 
```bash tab="npx"
npx shadcn@latest add https://snapiui.vercel.app/r/card-05.json
```

```bash tab="pnpm"
pnpm dlx shadcn@latest add https://snapiui.vercel.app/r/card-05.json
```
...
```jsx
import Card05 from "@/components/snapiui/card-05";
...
```bash tab="bun"
bunx shadcn@latest add https://snapiui.vercel.app/r/ai-card-generation.json
```
 
```bash tab="npx"
npx shadcn@latest add https://snapiui.vercel.app/r/ai-card-generation.json
```

```bash tab="pnpm"
pnpm dlx shadcn@latest add https://snapiui.vercel.app/r/ai-card-generation.json
```
...
```jsx
/**
 * Input08 require components
 * that will be automatically installed with the CLI.
 */
import Input08 from "@/components/snapiui/inputs/input-08";
...
```bash tab="bun"
bunx shadcn@latest add https://snapiui.vercel.app/r/card-05.json -c ./apps/www
```
 
```bash tab="npx"
npx shadcn@latest add https://snapiui.vercel.app/r/card-05.json -c ./apps/www
```

```bash tab="pnpm"
pnpm dlx shadcn@latest add https://snapiui.vercel.app/r/card-05.json -c ./apps/www
```
