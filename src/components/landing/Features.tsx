...
const Features = (props: Props) => {
    ...
    return (
        <div className='w-full max-w-none flex flex-col justify-start items-center z-10 mx-auto'>
            <div className="grid grid-col-3 md:flex md:flex-wrap items-center justify-start gap-6 md:gap-8 w-[95%] max-auto py-4 ">
                <motion.div
                    initial={{ y: 20, opacity: 0 }} whileInView={{ opacity: 1, y: 0 }}
                    viewport={{ once: true }} transition={{ duration: 0.3, delay: 0.1, ease: [0.23, 1, 0.32, 1] }}
                    className={cn("text-blue-600 dark:text-blue-400 relative flex flex-col items-center gap-2")}
                ...
                >
                    <svg
                        ...
                        role="img"
                    >
                        <title id="tailwindcss-icon-title">Tailwind CSS</title>
